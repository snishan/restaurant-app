...
import { Chart as ChartJS, Title, Tooltip, Legend, LineElement, CategoryScale, LinearScale } from 'chart.js'; // Chart.js components for setting up charts
import 'chart.js/auto'; // Automatically registers Chart.js components
import dashboardData from '../../lib/data/dashboardData.json'; // Import the JSON data
